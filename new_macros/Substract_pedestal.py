...
for run in [1,2,3]:
    ...
    ADC=open_run_var(path,"RawADC",Run_props["Channels"])
    
    Pedestal=do_run_things(ADC,compute_Pedestal)
    ADC=do_run_things((ADC,Pedestal,Run_props["Polarity"]),substract_Pedestal)
