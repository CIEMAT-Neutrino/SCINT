...
user_input, info = initialize_macro("11Average",["input_file","runs","key","load_preset","filter","debug"],default_dict=default_dict, debug=True)
...
average_wvfs(my_runs, info, key=user_input["key"][0], label="Ana", cut_label="SPE", centering="NONE", debug=user_input["debug"])
