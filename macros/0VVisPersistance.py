...
user_input, info = initialize_macro("0VVisPersistance", ["input_file","preset_load","runs","channels","filter","save","debug"], default_dict={}, debug=True)
...
vis_persistence(my_runs, info, OPT=OPT, save=user_input["save"], debug=user_input["debug"])