...
user_input = initialize_macro("0YVisHist2D",["input_file","variables","runs","channels","debug"],default_dict={}, debug=True)
...
vis_two_var_hist(my_runs, user_input["variables"], compare = "NONE", OPT = {"SHOW": True}, percentile=[0.1,99.9], select_range=False)